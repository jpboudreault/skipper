...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "duplicate_lineup_position": "Inning {inning}: Multiple players are assigned to position {position}: {players}.",
        "multiple_lineup_positions": "Inning {inning}: {player_name} is assigned to multiple positions ({positions}).",
        "invalid_lineup_position": "Lineup position {position} in inning {inning} is invalid.",
    ...
    "fr": {
        ...
        "duplicate_lineup_position": "Manche {inning} : plusieurs joueurs sont affectés à la position {position} : {players}.",
        "multiple_lineup_positions": "Manche {inning} : {player_name} est affecté à plusieurs positions ({positions}).",
        "invalid_lineup_position": "La position {position} à la manche {inning} est invalide.",
