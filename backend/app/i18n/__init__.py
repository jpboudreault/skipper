...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "microsoft_client_id_not_configured": "MICROSOFT_CLIENT_ID is not configured on the server.",
        "invalid_microsoft_token": "Invalid Microsoft token: {reason}",
        "microsoft_token_verification_failed": "Microsoft token verification failed: {reason}",
        "microsoft_email_missing": "Invalid Microsoft token payload: email missing",
        ...
        "pitcher_day_cap": "{player_name} is locked to pitch in {count} innings, exceeding their remaining daily limit of {remaining} (already pitched {pitched} inning(s) today).",
        ...
        "pitcher_reentry_day_cap": "Pitcher Re-entry & Cap violation: {player_name} is locked to pitch in Inning {first_inning} and Inning {last_inning}, forcing at least {min_required} consecutive innings, exceeding their remaining daily limit of {remaining}.",
    ...
    "fr": {
        ...
        "microsoft_client_id_not_configured": "MICROSOFT_CLIENT_ID n'est pas configuré sur le serveur.",
        "invalid_microsoft_token": "Jeton Microsoft invalide : {reason}",
        "microsoft_token_verification_failed": "Échec de la vérification du jeton Microsoft : {reason}",
        "microsoft_email_missing": "Charge utile du jeton Microsoft invalide : courriel manquant",
        ...
        "pitcher_day_cap": "{player_name} est verrouillé comme lanceur pour {count} manches, dépassant sa limite quotidienne restante de {remaining} (déjà {pitched} manche(s) aujourd'hui).",
        ...
        "pitcher_reentry_day_cap": "Violation de réentrée et limite : {player_name} est verrouillé comme lanceur à la manche {first_inning} et à la manche {last_inning}, forçant au moins {min_required} manches consécutives, dépassant sa limite quotidienne restante de {remaining}.",
